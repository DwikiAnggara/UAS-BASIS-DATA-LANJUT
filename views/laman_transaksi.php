<h3 style=" text-align: center;">TRANSAKSI</h3><hr>
<?php  
if(isset($_GET['add'])) :
...
<div class="grid_9" style="margin-left: 25%;">
	<form action="index.php" method="get">
		...
		<input type="submit" name="add" value="Masukkan" style="width: 100px; padding:6px;background-color:green; color:white;">
	</form>
</div>
<div class="grid_9">
...
<div style="width: 50%; float: left; margin-top:15px;">
	<a href="?p=laman_transaksi&destroy=true" style="padding: 7px; border-radius:5px; background-color:red; color:white;">Batalkan Transaksi</a>
</div>
<div class="grid_9" style="margin-left: 70%;">
	<form action="index.php" method="get">
		<input type="text" name="tunai" style="width: 175px;" placeholder="Dibayar.." required="">
		<input type="hidden" name="p" value="laman_transaksi">
		<input type="submit" name="selesai" value="Simpan" style="width: 100px; padding:6px;background-color:green; color:white;">
	</form>
